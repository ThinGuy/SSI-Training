# Ubuntu Server Advanced Training
...
```bash
sudo zfs destroy -r zfspool/mystuff/snap1clone
...
default network configuration renderer for Ubuntu 18.04 LTS (Bionic). It 
continues to be the default in Ubuntu 24.04 LTS (Noble) and all subsequent releases.
